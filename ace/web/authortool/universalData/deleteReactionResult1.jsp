...
<head>
	...
	<title>ACE Reaction Result Deleter</title>
...
<br/><br/>
	<form name="deleteReactionResult" method="post" action="deleteReactionResult2.jsp">
	<input type="hidden" name="rxnId" value="<%= rxnId %>" />
	<input type="hidden" name="starters" value="" />
	<table style="margin-right:auto; margin-left:auto; width:95%;">
		<tr><td class="regtext" 
				style="padding-top:10px; padding-bottom:10px;">
			Enter the starting material(s) whose calculated product(s), 
			when subject to <%= Utils.toDisplay(rxnCondnName) %>, you want
		...
		<tr><td style="text-align:center;">
			...
			<tr><td>
				<%= makeButton("Delete products", "deleteProds();") %>
			</td><td>
