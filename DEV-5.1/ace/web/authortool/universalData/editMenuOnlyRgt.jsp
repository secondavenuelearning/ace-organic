...
<head>
	...
	<title>ACE Menu-Only Reagent Editor</title>
	...
	function saveIt() {
		var form = document.saveMenuOnlyRgt;
		if (isWhiteSpace(form.smDef.value)) {
			alert('You must enter a SMILES definition of the reagent.');
			return;
		}
		if (isWhiteSpace(form.smName.value)) {
			alert('You must enter a name for the reagent.');
			return;
		}
		form.submit();
	} // saveIt()
	...
	function getSmiles() {
		marvinSketcherInstances['<%= APPLET_NAME %>'].
			...
			document.saveMenuOnlyRgt.smDef.value = source;
		}, function(error) {
...
<br/><br/>
	<form name="saveMenuOnlyRgt" method="post" action="saveMenuOnlyRgt.jsp">
	...
	<table style="margin-right:auto; margin-left:auto;">
		<tr>
		<td class="boldtext">
			Name of reagent only to be pulled from the reagents menu:
		</td>
		</tr>
		<tr>
		<td class="boldtext"> 
		...
		<tr><td class="regtext" 
			...
			Use this MarvinJS&trade; panel to acquire your SMILES string.
		</td></tr>
