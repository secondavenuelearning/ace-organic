...
<%@ page language="java" %>
<%@ page import="com.epoch.lewis.LewisMolecule"
%>
...
<head>
	...
	<script src="<%= pathToRoot %>js/lewisEquals.js" type="text/javascript"></script>
	...
	<script type="text/javascript">
		...
		function init() {
			setHeight('lewisJSCanvas', '<%= LewisMolecule.CANVAS_HEIGHT %>px');
			setWidth('LewisSketch_canvas', '<%= LewisMolecule.CANVAS_WIDTH %>px');
			initLewisConstants(
