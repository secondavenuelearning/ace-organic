...
<% 	final boolean isInstructorOrTA = true; 
	final String status = "preview";
%>
...
<script src="<%= pathToRoot %>nosession/marvin/marvin.js" type="text/javascript"></script>
<% if (containsJmol) { %>
...
<table summary="navigation" style="width:95%; margin-left:auto; margin-right:auto;">
	...
	<td>
		<%= makeButton(user.translate("Back"), "goBack(false);") %>
	</td>
	</tr>
</table>
</div>
